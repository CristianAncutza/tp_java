 ...
 * @author ex1fernajo
 */
public class frmViajeModificación extends javax.swing.JFrame {

    /**
     * Creates new form frmViajeModificación
     */
    public frmViajeModificación() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmViajeModificación.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmViajeModificación().setVisible(true);
            }
        });
    }
